	...
	<div class="container">
		<div class="row fullscreen d-flex justify-content-center align-items-center">
			<div class="banner-content col-lg-10 col-md-12 justify-content-center">
				<h6 class="text-uppercase">Selamat datang, <?= $this->session->userdata('nama'); ?></h6>
				<h1>
					INDONEPTUNE NET MFG			
				</h1>
				...
				<a href="<?= base_url().'aplikasi' ?>" class="primary-btn squire text-uppercase mt-10">Mulai Aplikasi sekarang</a>
			</div>											
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-5 col-md-6 col-sm-6">
				<div class="single-footer-widget">
					<h6>Tentang Kami</h6>
					<p>
						Pt.Indoneptune Net Manufacturing merupakan perusahaan jaring ikan dan peralatan perikanan pertama di Indonesia. sehingga dapat dipastikan kualitas dan kehandalan produknya dapat dipercaya.
					</p>							
				</div>
			</div>
			<div class="col-lg-5  col-md-6 col-sm-6">
				<div class="single-footer-widget">
					<h6>Berita</h6>
					<p>Nantikan semua update tentang produk kami</p>
					<div class="" id="mc_embed_signup">
						<form target="_blank" novalidate="true" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" method="get" class="form-inline">
							<input class="form-control" name="EMAIL" placeholder="Alamat email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Alamat email'" required="" type="email">
                            	<button class="click-btn"><i class="fa fa-arrow-right" aria-hidden="true"></i></button>
