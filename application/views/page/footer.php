		...
		<script src="<?= base_url().'assets/plugins/bootstrap/js/bootstrap-datepicker.min.js' ?>"></script>
		...
		<?php } ?>
		<?php if(isset($foot2) && $foot2=='mintauang'){ ?>
			<script src="<?= base_url().'assets/js/mintauang.js' ?>"></script>	
		<?php } ?>
		<?php if(isset($foot2) && $foot2=='absen'){ ?>
